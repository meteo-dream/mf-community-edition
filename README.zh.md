...
Windows 和 Linux 的临时构建版会由 GitHub Actions 工作流在每次提交时自动编译，你可以 [在这里下载](https://nx.wtf/s/2GqcQ)。这些版本不是稳定版。
...
Mario Forever: Community Edition 的源代码采用 [BSD 3-Clause License](LICENSE) 授权。版权所有（c）2024-2026，Meteo Dream 及贡献者。

[engine/](engine/) 子模块单独采用 [BSD 2-Clause License](engine/LICENSE) 授权。任天堂和 Buziol 的素材仍归其各自所有者所有。
